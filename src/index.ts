...
export abstract class JSXFactory {
	...
	static createFragment(properties): HTMLElement {
		...
		return DOMparseNode(document.createDocumentFragment(), properties, children);
	}
}
...
type WritableKeysOf<T> = {
    [P in keyof T]: T[P] extends Function ? never : IfEquals<{ [Q in P]: T[P] }, { -readonly [Q in P]: T[P] }, P, never>
}[keyof T];
...
export type Props<T, ChildrenType = AnyNode> = Partial<WritablePart<T>> & {children?: ChildrenType[] }
